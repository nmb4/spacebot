...
fn extra_models() -> Vec<ModelInfo> {
    vec![
        ...
        ModelInfo {
            id: "antigravity/claude-opus-4-5-thinking".into(),
            name: "Claude Opus 4.5 Thinking".into(),
        ...
        ModelInfo {
            id: "antigravity/claude-sonnet-4-5-thinking".into(),
            name: "Claude Sonnet 4.5 Thinking".into(),
            provider: "antigravity".into(),
            context_window: None,
            tool_call: true,
            reasoning: true,
        ...
        ModelInfo {
            id: "antigravity/gemini-3-pro-high".into(),
            name: "Gemini 3 Pro High".into(),
            provider: "antigravity".into(),
            context_window: None,
            tool_call: true,
            reasoning: true,
        ...
        ModelInfo {
            id: "antigravity/gemini-3-pro-low".into(),
            name: "Gemini 3 Pro Low".into(),
            provider: "antigravity".into(),
            context_window: None,
            tool_call: true,
            reasoning: true,
        ...
        ModelInfo {
            id: "antigravity/gpt-oss-120b-medium".into(),
